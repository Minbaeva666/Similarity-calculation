...
public class MainProgram {
    public static void main(String[] args) {
        try {
            ...
            wordProcessor1.readFile("C:\\Users\\Пользователь\\IdeaProjects\\untitled\\src\\file1.txt");
            Set<String> distinctWords1 = wordProcessor1.getDistinctWords();

            WordProcessor wordProcessor2 = new WordProcessor();
            wordProcessor2.readFile("C:\\Users\\Пользователь\\IdeaProjects\\untitled\\src\\file2.txt");
